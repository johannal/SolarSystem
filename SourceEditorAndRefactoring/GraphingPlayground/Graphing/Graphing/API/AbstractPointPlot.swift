...
public class AbstractPointPlot {
    ...
    public func darkenPlot() {
        linePlotDrawable.color = linePlotDrawable.color.darker()
    }
    
    public func darkenPlot(percent: Double) {
        linePlotDrawable.color = linePlotDrawable.color.darker(percent: percent)
    }
}
