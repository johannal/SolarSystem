...
echo "Setting test navigator defaults"
defaults write com.apple.dt.Xcode IDETestNavigatorSortAlphabetical -bool YES

echo "Setting test action scheme editor defaults"
defaults write com.apple.dt.Xcode IDETestSchemeActionVerboseSubtitles -bool YES
